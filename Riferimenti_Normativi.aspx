<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Riferimenti_Normativi.aspx.cs" Inherits="Generatore_Web.Riferimenti_Normativi" %>
                    ...
                    <div class="overflow-modal-container">
                        <div class="table-container">
                            <table class="table table-feature">
                                <asp:Repeater ID="rpt_norme" runat="server" OnItemCommand="rpt_norme_ItemCommand"
                                        OnItemDataBound="rpt_norme_ItemDataBound">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="tmiddle tleft">
                                                <div class="checkbox right fullwidth checkbox-verifiche">
                                                    <asp:CheckBox ID="chk_norma" runat="server" />
                                                    <label for="" id="lbl_norma" runat="server">
                                                        <asp:Literal ID="ltl_norma" runat="server"></asp:Literal>
                                                        <asp:Literal ID="ltl_norma_key" runat="server" Visible="false"></asp:Literal>
                                                    </label>
                                                </div>
                                            </td>
                                        </tr>
